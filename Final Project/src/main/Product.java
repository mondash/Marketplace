...
public class Product {
	...
	/**
	 * Product Constructor: 
	 * @param itemNumber - integer ID of the Product
	...
	/**
	 * @param name - the name to set the Product
	 */
	...
	/**
	 * @param desc - the description to set the Product
	 */
	...
	/**
	 * @param category - the category to set the Product 
	 */
	...
	/**
	 * @param cost - the cost to set the Product
	 */
	...
	/**
	 * Subtracts the amount from the Product's quantity; includes a safety catch as to disallow negative quantities
	 * @param amount - the number of Products to purchase
	 */
	...
	/**
	 * @param amount - the amount to set the Product quantity
	 */
