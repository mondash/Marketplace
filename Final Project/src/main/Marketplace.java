...
public class Marketplace {
	...
	/**
	 * Marketplace Constructor: initializes new Directory and Inventory, sets current Account to be null
	 */
	public Marketplace() {
	 ...
	 * @param percentage - the percentage to set (in decimal form)
	 */
	...
	/**
	 * @return the percentage of profits a Seller receives for sales (in decimal form)
	 */
	 ...
	 * @param name - the name of the Account to attempt access 
	 * @param password - the password of the Account to attempt access
	...
	/**
	 * Compensates the Seller and Admin while charging the Buyer for the transaction of the passed cart
	 * @param cart - the cart to fulfill the transaction
	 */
	...
	/**
	 * Updates quantities in the Marketplace's Inventory corresponding to the cart
	 * @param cart - the cart whose items to sell
	 */
	 ...
	 * @param adminRevenue - the amount of revenue the Admins have received
	 */
	 ...
	 * @param constantsDir - the filepath to read
	 */
	 ...
	 * @param constantsDir - the filepath to save to
	 */
	...
	/**
	 * Loads all needed resources for the Marketplace to function at the specified filepaths
	 * @param constantsDir - filepath to save the constants
	 * @param inventoryDir - filepath to save the Inventory
	 * @param directoryDir - filepath to save the Directory
	 */
